...
Mapper::Gps_Descriptor Mapper::getPositionDescriptor(double latitude, double longitude, int forcedRoadID) {
...
std::optional<Mapper::Merging_Scenario> Mapper::getFakeCarMergingScenario(double latitude, double longitude) {  // Beware that method is tweaked for our use case. Such as the the road = 1 and lane = 1.
